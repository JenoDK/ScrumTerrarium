 ...
 */
public class SwingTerrarium extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setLayout(new java.awt.GridLayout(6, 6, 2, 2));

        jLabel2.setText("Terrarium");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SwingTerrarium.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                //new SwingTerrarium().setVisible(true);
            }
        });
    }
